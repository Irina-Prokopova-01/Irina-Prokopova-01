## Привет! Меня зовут Ирина (@Irina-Prokopova-01).
Я начинающий Python - разработчик, люблю чистый и понятный код.
## Немного обо мне
Использую Django, DRF, изучаю FastAPI (сертификат по ссылке https://stepik.org/cert/2897171).
## Мои навыки:
  * Языки:  Python (начинальный уровень)
...
## Связаться со мной
  * Telegram: @m4twins
  * Email: irina-prokopova.style@yandex.ru
